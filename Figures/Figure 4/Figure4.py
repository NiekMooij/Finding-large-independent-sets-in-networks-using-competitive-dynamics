...
df = pd.read_pickle(os.path.join(sys.path[0], f"data/erdos_renyi_size_sparse_performance.pkl"))
...
ax3.set_yticks([0.8, 0.85, 0.9, 0.95, 1], ['0.80', '0.85', '0.90', '0.95', '1.00'])

# -------------------------------------------------------------------------------------------------------------------------------------------------

# size - dense - performance
df = pd.read_pickle(os.path.join(sys.path[0], f"data/erdos_renyi_size_dense_performance.pkl"))
...
ax5.set_yticks([0.6, 0.7, 0.8, 0.9, 1], ['0.60', '0.70', '0.80', '0.90', '1.00'])

# -------------------------------------------------------------------------------------------------------------------------------------------------

# histogram
df = pd.read_pickle(os.path.join(sys.path[0], f"data/erdos_renyi_histogram.pkl"))
...
df = pd.read_pickle(os.path.join(sys.path[0], f"data/erdos_renyi_size_sparse_efficiency.pkl"))
...
df = pd.read_pickle(os.path.join(sys.path[0], f"data/erdos_renyi_size_dense_efficiency.pkl"))
...
df = pd.read_pickle(os.path.join(sys.path[0], f"data/erdos_renyi_size_sparse_worst_case.pkl"))
...
df = pd.read_pickle(os.path.join(sys.path[0], f"data/erdos_renyi_size_dense_worst_case.pkl"))
...
plt.savefig(os.path.join(sys.path[0], 'Figure4.pdf'), transparent=True, dpi=900, bbox_inches='tight')
plt.show()